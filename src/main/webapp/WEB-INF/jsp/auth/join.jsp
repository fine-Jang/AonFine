        ...
        <div class="col-md-6">
          <div class="form_container">
            ...
            <form method="post" action="${pageContext.request.contextPath}/joinProcess.do">
              <div>
                <input type="text" name="userId" class="form-control" placeholder="아이디" value="${fn:escapeXml(user.userId)}" required>
              </div>
              <div>
                <input type="password" name="password" class="form-control" placeholder="패스워드" required>
              </div>
              <div>
                <input type="text" name="userName" class="form-control" placeholder="이름" value="${fn:escapeXml(user.userName)}" required>
              </div>
              <div>
                <input type="text" name="phoneNo" class="form-control" placeholder="연락처" value="${fn:escapeXml(user.phoneNo)}">
              </div>
              <div class="btn_box">
                <button type="submit">가입</button>
                <a href="${pageContext.request.contextPath}/login.do" class="btn btn-secondary">로그인</a>
              </div>
            </form>
          </div>
        </div>
